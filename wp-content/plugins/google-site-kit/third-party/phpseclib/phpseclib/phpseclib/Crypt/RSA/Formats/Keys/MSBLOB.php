...
abstract class MSBLOB
{
    ...
    public static function load($key, $password = '')
    {
        ...
        $unpacked = \unpack('atype/aversion/vreserved/Valgo', \Google\Site_Kit_Dependencies\phpseclib3\Common\Functions\Strings::shift($key, 8));
        $type = $unpacked['type'];
        ...
        $unpacked = \unpack('Vmagic/Vbitlen/a4pubexp', \Google\Site_Kit_Dependencies\phpseclib3\Common\Functions\Strings::shift($key, 12));
