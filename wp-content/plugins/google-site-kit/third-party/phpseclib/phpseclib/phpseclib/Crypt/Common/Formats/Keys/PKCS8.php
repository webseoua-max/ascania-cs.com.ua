        ...
        if (\strlen($password) && \is_array($decrypted)) {
            ...
            switch ($algorithm) {
                ...
                case 'pbeWithSHAAnd40BitRC4':
                    ...
                    $map = \Google\Site_Kit_Dependencies\phpseclib3\File\ASN1::asn1map($temp[0], \Google\Site_Kit_Dependencies\phpseclib3\File\ASN1\Maps\PBEParameter::MAP);
                    $salt = $map['salt'];
                ...
                case 'id-PBES2':
                    ...
                    if (!$cipher instanceof \Google\Site_Kit_Dependencies\phpseclib3\Crypt\RC2) {
                        ...
                        $map = \Google\Site_Kit_Dependencies\phpseclib3\File\ASN1::asn1map($temp[0], \Google\Site_Kit_Dependencies\phpseclib3\File\ASN1\Maps\RC2CBCParameter::MAP);
