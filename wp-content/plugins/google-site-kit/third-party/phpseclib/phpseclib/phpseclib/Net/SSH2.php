...
class SSH2
{
    ...
    private function get_binary_packet()
    {
        ...
        $padding_length = \unpack('Cpadding_length', \Google\Site_Kit_Dependencies\phpseclib3\Common\Functions\Strings::shift($payload, 1))['padding_length'];
        if ($padding_length > 0) {
            ...
            switch ($this->decryptName) {
                ...
                default:
                    if (!$this->hmac_check instanceof \Google\Site_Kit_Dependencies\phpseclib3\Crypt\Hash || !$this->hmac_check_etm) {
                        ...
                        $packet_length = \unpack('Npacket_length', \Google\Site_Kit_Dependencies\phpseclib3\Common\Functions\Strings::shift($packet->plain, $packet_length_header_size))['packet_length'];
        ...
        if ($this->bitmap & self::MASK_CONNECTED && $this->isAuthenticated()) {
            switch (\ord($payload[0])) {
                ...
                case NET_SSH2_MSG_GLOBAL_REQUEST:
                    ...
                    \Google\Site_Kit_Dependencies\phpseclib3\Common\Functions\Strings::shift($payload, 1);
                    list($request_name, $want_reply) = \Google\Site_Kit_Dependencies\phpseclib3\Common\Functions\Strings::unpackSSH2('sb', $payload);
                    ...
                    case NET_SSH2_MSG_CHANNEL_REQUEST:
                        ...
                        switch ($value) {
                            ...
                            case 'exit-status':
                                ...
                                continue 3;
                            default:
                                list($want_reply) = \Google\Site_Kit_Dependencies\phpseclib3\Common\Functions\Strings::unpackSSH2('b', $response);
                                if ($want_reply) {
