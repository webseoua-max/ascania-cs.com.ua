...
class StreamHandler
{
    ...
    private function createStream(\Google\Site_Kit_Dependencies\Psr\Http\Message\RequestInterface $request, array $options)
    {
        ...
        return $this->createResource(function () use($uri, $contextResource, $context, $options, $request) {
            ...
            if (\function_exists('Google\\Site_Kit_Dependencies\\http_get_last_response_headers')) {
                /** @var array|null */
                $http_response_header = \Google\Site_Kit_Dependencies\http_get_last_response_headers();
            }
